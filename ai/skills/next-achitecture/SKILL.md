...
description: >
  ...
  Use this when project is built on top of Next.js and whenever the user asks where a file should go, 
  how to organize a new layouts, pages and folders inside the app folder — even if they phrase it 
  casually like "where do I put this?" or "how should I structure this?". Also use it when creating 
  new files or folders, refactoring existing structure, or reviewing whether something is in the 
  right place.
---
